...
namespace Service
{
    internal sealed class CompanyService : ICompanyService
    {
        ...
        public async Task<CompanyDto> CreateCompanyAsync(CompanyForCreationDto
            company)
        {
        ...
        public async Task<(IEnumerable<CompanyDto> companies, string ids)>
            CreateCompanyCollectionAsync(IEnumerable<CompanyForCreationDto>
            companyCollection)
        {
        ...
        private async Task<Company> GetCompanyAndCheckIfItExists
